...
$id = $_GET['id_tim'];
$query = "SELECT * FROM tim_proyek WHERE id_tim = '$id'";
...
<body>
    ...
    <div class="container">
        <h2>Edit Tim</h2>
        <form id="editTeamForm" action="update-tim.php" method="post">
            <div class="mb-3">
                <label for="editIdTim" class="form-label">Id Tim</label>
                <input type="text" name="id_tim" class="form-control" value="<?php echo $row['id_tim']; ?>" readonly>
                <label for="editNamaTim" class="form-label">Nama Tim</label>
                <input type="text" class="form-control" id="editNamaTim" name="nama_tim" value="<?php echo $row['nama_tim']; ?>" required>
            </div>
            <button type="submit" name="submit" class="btn btn-primary">Update</button>
            <a href="tim.php" class="btn btn-danger">Batal</a>
        </form>
    </div>
