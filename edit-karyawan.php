...
<body>
    ...
    <div class="container">
        <h2>Edit Karyawan</h2>
        <form id="editTeamForm" action="update-karyawan.php" method="post">
            <div class="mb-3">
                <label for="editIdTim" class="form-label">Id Karyawan</label>
                <input type="text" name="id_karyawan" class="form-control" value="<?php echo $row['id_karyawan']; ?>" readonly>
                <label for="editNamaTim" class="form-label">Nama Karyawan</label>
                <input type="text" class="form-control" id="editNamaTim" name="nama_karyawan" value="<?php echo $row['nama_karyawan']; ?>" required>
                <label for="editNamaTim" class="form-label">Jabatan</label>
                <input type="text" class="form-control" id="editNamaTim" name="jabatan" value="<?php echo $row['jabatan']; ?>" required>
                <label for="editNamaTim" class="form-label">Gaji</label>
                <input type="number" class="form-control" id="editNamaTim" name="gaji" value="<?php echo $row['gaji']; ?>" required>
